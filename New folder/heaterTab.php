						...
						<?php
							...
							?>
								...
								<div class="rowCheckbox switch">
									...
									<div class="custom-checkbox"><input type="checkbox" value="<?php echo $i;?>" id="relayHeater-<?php echo $i?>" name="relayHeater[]" hidefocus="true" style="outline: medium none;">
									<label id="lableRelay-<?php echo $i?>" for="relayHeater-<?php echo $i?>"><span style="color:#C9376E;">&nbsp;</span></label>
									</div>
								</div>
