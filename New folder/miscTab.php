<h3>Miscellaneous Device</h3>
			...
			<select name="no_misc" id="no_misc" class="form-control">
				<option <?php if(isset($arrMore['misc']) &&  $arrMore['misc'] == ''){echo 'selected="selected"';}?> value="">Select number of blowers</option>
				<?php
						...
						<div class="inner">
							...
							?>
								...
								<div class="rowCheckbox switch">
									...
									<div class="custom-checkbox"><input type="checkbox" value="<?php echo $i;?>" id="relayMisc-<?php echo $i?>" name="relayMisc[]" hidefocus="true" style="outline: medium none;">
