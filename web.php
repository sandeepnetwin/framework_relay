    ...
    **/
    ...
    class Web extends CI_Controller
    {
        ...
        public function changeDeviceStatus()
        {
            ...
            #INPUTS
			$ipID			 = isset($_REQUEST['ip']) ? $_REQUEST['ip'] : '' ; // IP ID
		...
		//START: Create Custom Program For Devices.
		public function createCustomProgram()
		{
			...
			//Input Data
			$aData	=	json_decode(trim($_REQUEST['input_data']));
			$g_id	= 	$aData->g_id;
			...
			$this->home_model->saveCustomProgram($g_id,json_encode($aData));
			
			$aResponse['code']      = 1;
			$aResponse['status']    = $this->aApiResponseCode[ $aResponse['code'] ]['HTTP Response'];
			$aResponse['data']      = "Program is saved successfully for GID - ".$g_id;
			
			$this->webResponse($sformat, $aResponse);
		}
		//END: Create Custom Program For Devices.
		
		//START: Edit Custom Program For Devices.
