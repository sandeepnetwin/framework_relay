<h3>Valve Setting</h3>
            <section>
			<div class="col-sm-12">
				<label for="strValve">How many AUTOMATIC valves do you have on<br /> your pool and or pool/spa system?<span class="requiredMark">*</span>&nbsp;<img src="<?php echo HTTP_ASSETS_PATH.'images/help.png';?>" width="24" class="tooltipster-icon" title="Please select number of valve used in the mode?" /></label><a class="changeLink" id="changeLinkValve" href="javascript:void(0);" onclick="javascript:$('#valveForm').toggleClass('disableConfig');" style="float:right;" title="Click here to Enable/Disable valve related settings!">Enable/Disable Valve Configuration</a>
						...
						<div class="inner">
							...
							?>
								...
								<div class="rowCheckbox switch">
									...
									<div class="custom-checkbox"><input type="checkbox" value="<?php echo $i;?>" id="relayValve-<?php echo $i?>" name="relayValve[]" hidefocus="true" style="outline: medium none;">
									<label id="lableRelay-<?php echo $i?>" for="relayValve-<?php echo $i?>"><span style="color:#C9376E;">&nbsp;</span></label>
									</div>
								</div>
					...
					<div id="valveForm" class="disableConfig" >	
						...
						<table class="table removeBorder" id="valveTable" width="100%" cellspacing="0" cellpadding="0">
						 <tbody>
							...
							?>
										<tr><td><strong>Valve <?php echo $valve->device_number;?></strong>&nbsp;<span class="relayText">(Enter relays in sequence)</span></td><td>&nbsp;</td><td><input type="text" style="width:50px; display:inline;" class="inputText" id="sRelay<?php echo $i;?>_1" value="<?php echo $valve_relay_number['Relay1'];?>">&nbsp;&nbsp;<input type="text" style="width:50px; display:inline;" class=" inputText" id="sRelay<?php echo $i;?>_2" value="<?php echo $valve_relay_number['Relay2'];?>">&nbsp;<a class="changeLink" href="javascript:void(0);" onclick="removeRow('valveTable')">Remove</a><div style="height: 5px;"> </div><select class="form-control" style="width:100px !important; display:inline;" name="valveDirection_<?php echo $i;?>_1"><option value="">Select Directions</option><option value="pool">Pool</option><option value="spa">Spa</option></select>&nbsp;&nbsp;<select class="form-control" style="width:100px !important; display:inline;" name="valveDirection_<?php echo $i;?>_2"><option value="">Select Directions</option><option value="pool">Pool</option><option value="spa">Spa</option></select></td></tr>
							<?php
										$i++;
									}
									
									echo '<tr><td colspan="3"><a href="javascript:void(0);" onclick="checkAndSaveRelays();" class="btn btn-middle"><span>Save</span></a>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="javascript:$(\'#valveForm\').toggleClass(\'disableConfig\');" class="btn btn-middle btn-red"><span>Cancel</span></a>&nbsp;&nbsp;<span id="loadingImg" style="display:none; vertical-align: middle;"><img src="'.site_url('assets/images/loading.gif').'" alt="Loading...." width="32" height="32"></span></td></tr>';
								  }
							?>
						 </tbody>		
						</table>
