<h3>Pump Setting</h3>
			...
			<div class="col-sm-12">
			<label for="automatic_pumps">How many Pumps do you have?<span class="requiredMark">*</span>&nbsp;<img src="<?php echo HTTP_ASSETS_PATH.'images/help.png';?>" width="24" class="tooltipster-icon" title="Please select number of pumps used in the mode?" /></label><a class="changeLink" id="changeLinkPump" href="javascript:void(0);" onclick="javascript:$('#pumpForm').toggleClass('disableConfig');" style="float:right;" title="Click here to Enable/Disable pump related settings!">Enable/Disable Pump Configuration</a>
					...
					<div class="inner">
						...
						?>
							...
							<div class="rowCheckbox switch">
								...
								<div class="custom-checkbox"><input type="checkbox" value="<?php echo $i;?>" id="relayPump-<?php echo $i?>" name="relayPump[]" hidefocus="true" style="outline: medium none;">
								<label id="lableRelay-<?php echo $i?>" for="relayPump-<?php echo $i?>"><span style="color:#C9376E;">&nbsp;</span></label>
								</div>
							</div>
