            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <div id="morris-chart-area">
                  <form action="<?php echo site_url('home/positionName/'.base64_encode($sDeviceID).'/'.base64_encode($sDevice).'/');?>" method="post">
                  ...
                  <input type="hidden" name="sDevice" value="<?php echo base64_encode($sDevice);?>">
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                      <tr>
                        ...
                        <td width="1%">&nbsp;</td>
                        <td width="89%"><input type="text" class="form-control" placeholder="Enter Position 1 Name" name="sPositionName1" value="<?php echo $sPositionName1;?>" id="sDeviceName" required></td>
                      </tr>
                      <tr><td colspan="3">&nbsp;</td></tr>
                      <tr>
                        <td width="10%"><strong>Enter Position 2:</strong></td>
                        <td width="1%">&nbsp;</td>
                        <td width="89%"><input type="text" class="form-control" placeholder="Enter Position 2 Name" name="sPositionName2" value="<?php echo $sPositionName2;?>" id="sDeviceName" required></td>
                      </tr>
                      <tr><td colspan="3">&nbsp;</td></tr>
